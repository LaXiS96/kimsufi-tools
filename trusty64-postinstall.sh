...
apt-get -y install linux-generic-lts-vivid && mv /etc/grub.d/06_OVHkernel /etc/grub.d/25_OVHkernel && update-grub
...
echo
echo "Please remember to add \"pre-up iptables-restore < /etc/iptables.rules\" to your main network interface!"
echo "Done!"
